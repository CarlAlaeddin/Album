...
<div class="main-wrapper">
    ...
    <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url({{ asset('/Panel/assets/images/big/auth-bg.jpg') }}) no-repeat center center;">
        <div class="auth-box">
            <div>
                <div class="logo">
                    <span class="db"><img alt="thumbnail" class="rounded-circle" width="100" src="Panel/assets/images/users/1.jpg"></span>
                    ...
                    <div class="col-12">
                        <form class="form-horizontal m-t-20" method="POST" action="{{ route('password.confirm') }}">
                            ...
                            <div class="form-group row">
                                <div class="col-12">
                                    <input class="form-control form-control-lg @error('password') is-invalid @enderror" type="password" required="" placeholder="Password">
                                    @error('password')
                            ...
                            <div class="form-group text-center">
                                <div class="col-xs-12 p-b-20">
                                    ...
                                    @if (Route::has('password.request'))
                                        <a class="btn btn-block btn-lg btn-info" href="{{ route('password.request') }}">
